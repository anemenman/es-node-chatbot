...
module.exports = function(controller) {
    ...
    function conductOnboarding(bot, message) {
      ...
      bot.startConversation(message, function(err, convo) {
        ...
        convo.say({
          text: 'Здравствуйте! Это онлайн-консультант по вопросам жилищной сферы. Если в моей базе данных будет недостаточно информации - к нашему диалогу подключится оператор!',
          // quick_replies: [
          //   {
          //     title: 'Help',
          //     payload: 'help',
